...
namespace RocketSim
{
    internal static class TelemetryMetricCatalog
    {
        ...
        static readonly TelemetryMetricDescriptor[] MetricCatalog =
        {
            ...
            new("Leg_PropulsionOff01", cfg => cfg.logGoalMetrics, r => r.leg_propulsionOff01),
            ...
            new("Ctrl_EngineFirstIgnitionCount", cfg => cfg.logControlMetrics, r => r.ctrl_engineFirstIgnitionCount),
